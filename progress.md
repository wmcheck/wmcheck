...
- Разработка программного комплекса "РЕЕСТР ОПО" (Реестр Опасных Производственных объектов) для системы АИСПБ
(более 300тыс. ОПО, около 90тыс. поднадзорных организаций и более 1.5млн технических устройств):
...
- Внедрение и доработка закрытого раздела РЕЕСТР ОПО в силовые ведомства ФСО, ФСБ, СВР, Минобороны, ФСИН, МВД, а так же развертываение комплекса в ЦА ОАО "РЖД" для самостоятельного ведения реестра ОПО.
